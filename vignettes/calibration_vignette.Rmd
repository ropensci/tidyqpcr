...
plate1plan %>%
  filter(tech_rep == "1", target_id == target_id_levels[1], dilution_nice == "1x")

plate1plan %>%
  filter(tech_rep == "2", target_id == target_id_levels[4])
```
...
ggplot(
  data = platesamp %>%
    filter(tech_rep == "1"),
  aes(x = cycle, y = fluor_signal, colour = factor(dilution), linetype = prep_type)
) +
  facet_grid(target_id ~ biol_rep, scales = "free_y") +
  ...
  labs(title = "All Amp Curves, Tech. Rep. A")
...
ggplot(
  ...
  geom_line() +
  scale_x_continuous(breaks = seq(60, 100, 10), minor_breaks = seq(60, 100, 5)) +
  labs(title = "All Amp Curves, Tech. Rep. B")
```
...
ggplot(
  ...
  geom_line() +
  scale_x_continuous(breaks = seq(60, 100, 10), minor_breaks = seq(60, 100, 5)) +
  labs(title = "All Melt Curves, Tech. Rep. A")
...
ggplot(
  ...
  geom_line() +
  scale_x_continuous(breaks = seq(60, 100, 10), minor_breaks = seq(60, 100, 5)) +
  labs(title = "All Melt Curves, Tech. Rep. B")
```
...
ggplot(
  ...
  labs(title = "Melt curves, zoomed, Tech. Rep. A") +
  theme(
...
ggplot(
  ...
  labs(title = "Melt curves, zoomed, Tech. Rep. B") +
  theme(
    panel.grid.major.x = element_line(colour = "grey50", size = 0.4),
    panel.grid.minor.x = element_line(colour = "grey70", size = 0.1)
  )
...
ggplot(
  data = platesmelt %>%
    filter(
      tech_rep == "1", prep_type == "+RT", dilution_nice == "1x",
  ...
  labs(title = "Nice probes, Tech. Rep. A") +
  theme(
    panel.grid.major.x = element_line(colour = "grey50", size = 0.4),
    panel.grid.minor.x = element_line(colour = "grey70", size = 0.1)
  )
