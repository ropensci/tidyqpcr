...
ggplot(
  data = platesamp %>%
    filter(TechRep == 1, BiolRep == 1),
  aes(x = Cycle, y = Signal, linetype = prep_type)
) +
  facet_grid(Condition ~ target_id) +
  geom_line() +
  scale_linetype_manual(values = c("-RT" = "dashed", "+RT" = "solid")) +
