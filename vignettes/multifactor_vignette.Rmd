...
This plot shows all the summarized data "faceted" on different axes for different drug treatments. It is easy to see that, for example, SSA4 detection increases in response to heat in all drug treatments.
