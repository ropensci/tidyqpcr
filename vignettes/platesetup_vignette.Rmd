...
For example, the default values of `prep_type` are relevant for RT-qPCR, and you would want to change those for plain qPCR or ChIP-qPCR.
Please consult the function documentation for details of the paramters and outputs, e.g. `?create_colkey_6_in_24`.
