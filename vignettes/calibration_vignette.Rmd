...
plates <- read_lightcycler_1colour_cq(
  system.file("extdata/Edward_qPCR_Nrd1_calibration_2019-02-02_Cq.txt.gz",
              package = "tidyqpcr")) %>%
...
summary(plates)
```
# Check for positional effects across plate
Sometimes wells close the the edge of the plate exhibit different behavior to central wells.

```{r check_edge_effects,dependson="load_plates",results="show"}
