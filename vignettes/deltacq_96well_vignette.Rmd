...
plate_cq_extdata <- read_tsv(
  "../inst/extdata/Stuart_dAgr_glyS_spoVG_5S_individualWells_Cq_select.txt"
  )
...
* Calculate delta Cq and relative abundance using `calculate_deltacq_bysampleid`. This process normalizes gene levels to the levels of a reference gene within each sample.
* Calculate delta delta Cq and fold change using `calculate_deltadeltacq_bytargetid`. This process normalizes each gene levels for each sample to levels of the same gene in a control sample. 
