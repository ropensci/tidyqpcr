...
Calibration curves with slope and y intercept | Slope | No | No | Yes | Yes
...
Method of Cq determination FIXME | N/A | Relative (5 methods) | Relative (deltaCq) | Sigmoidal model selection | Relative (deltacq)
...
Justification of number and choice of reference genes | User defined (vignettes encourage 3) | User defined (vignettes encourage 2) | Automatic Selection (vignettes encourage 2) | Yes | One 
...
Repeatability | No† | Yes + Docs | No | Yes + Docs | No
