---
title: "Probe calibration vignette"
...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{ProbeCalibration}
...
plate1plan %>% 
           filter(TechRep=="2",Probe==Probes[4])
```
...
# Analyze Ct (quantification cycle count) data
...
Visual display of linearity of Ct with log(Dilution).
...
Use regression to estimate linearity of Ct with log(Dilution), including the slope or efficiency.
