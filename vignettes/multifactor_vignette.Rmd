...
plate1 <- read_lightcycler_1colour_cq(
  system.file("extdata/Edward_qPCR_TxnInhibitors_HS_2018-06-15_plate1_Cq.txt.gz",
              package = "tidyqpcr")) %>%
  left_join(plateplan) %>%
...
plate2 <- read_lightcycler_1colour_cq(
  system.file("extdata/Edward_qPCR_TxnInhibitors_HS_2018-06-15_plate2_Cq.txt.gz",
              package = "tidyqpcr")) %>%
  left_join(plateplan) %>%
...
plate1curve <- read_lightcycler_1colour_raw(
  system.file("extdata/Edward_qPCR_TxnInhibitors_HS_2018-06-15_plate1.txt.gz",
              package = "tidyqpcr")) %>%
  debaseline() %>%
  left_join(plateplan) %>%
  mutate(biol_rep = 1, plate = 1)
...
plate2curve <- read_lightcycler_1colour_raw(
  system.file("extdata/Edward_qPCR_TxnInhibitors_HS_2018-06-15_plate2.txt.gz",
              package = "tidyqpcr")) %>%
  debaseline() %>%
  left_join(plateplan) %>%
  mutate(biol_rep = 2, plate = 2)
