...
#' @describeIn normalizeqPCR Normalise cycle count (log2-fold) data within
#'   SampleID. Synonym for normalizeqPCR.
#'
#' @export
#' @importFrom magrittr %>%
#'
normaliseqPCR <- function(cq_df,
                          value = "Cq",
                          normTargetIDs = "ALG9",
                          probename = "TargetID") {
    normalizeqPCR(cq_df = cq_df,
                  value = value,
